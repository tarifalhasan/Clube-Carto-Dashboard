  ...
  return (
    <div>
      ...
      <div className=" space-y-5 pb-1">
        <SubHeader name="Adicionar funcionário" href="/employees" />
        <div>
              ...
              <div className=" w-full lg:w-[565px]">
                <Select>
                  <SelectTrigger className=" min-w-full w-full">
                    <SelectValue placeholder="Nome do Funcionário" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectGroup>
          ...
          <div className=" mt-10 space-y-4 bg-white rounded-2xl p-5 lg:p-8 ">
            <div className=" p-5 inline-flex items-center gap-2">
              <h2 className=" text-base lg:text-4xl">
                Adicione as permissões do grupo adicionado
              </h2>
              <CheckMark />
            </div>
...
export default AdicionarFuncionário;
