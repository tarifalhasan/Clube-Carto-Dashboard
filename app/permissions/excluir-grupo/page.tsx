import { CloseMark } from "@/assets/svg/icons";
...
import { CheckboxReactHookFormMultiple } from "./group-permissions";
  ...
  return (
    <div>
      ...
      <div className=" space-y-5 pb-1">
        <SubHeader name="Excluir grupo" href="/permissions" />
        <div>
          ...
          <div className=" mt-10 space-y-4 bg-white rounded-2xl p-5 lg:p-8 ">
            <div className=" p-5 inline-flex items-center gap-2">
              ...
              Seleciona as permissões do grupo que deseja excluir
              </h2>
              <CloseMark />
            </div>
